...
export interface Estadisticas {
  ...
  Hombres: string,
  Mujeres: string,
  Hombres_solos: string,
  Mujeres_solas: string,
  Matrimonios: string,
  Occidente: string,
  Centro_Oeste: string,
  Centro_Este: string,
  ...
  Villa_Clara: string,
  Cienfuegos: string,
  Sancti_Spiritu: string,
  Ciego_de_Ávila: string,
  Camagüey: string,
  Las_Tunas: string,
  Holguín: string,
  Granma: string,
  Santiago_de_Cuba: string,
  Guantánamo: string,
  Isla_de_la_Juventud: string,
}
